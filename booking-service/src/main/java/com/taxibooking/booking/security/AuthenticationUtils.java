...
/**
 * Authentication utility class provide functions for managing base64 encoding/decoding and hashing
 * of user passwords.
 *
 * @author vinodkandula
 */
  ...
  public static String generateCode(String validCodeCharacters, int length) {
    ...
    if (length == 0 || validCodeCharacters.length() == 0) {
      IllegalArgumentException e =
          new IllegalArgumentException("Password or validCodeCharacters length cannot be 0");
      LOGGER.log(Level.WARNING, e.getMessage());
      throw e;
    }
