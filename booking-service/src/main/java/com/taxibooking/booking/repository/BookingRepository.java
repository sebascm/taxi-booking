...
/**
 * A BookingRepository class for handling and managing event related data requested, updated, and
 * processed in the application and maintained in the database.
 *
 * @author vinodkandula
 */
@Transactional
public interface BookingRepository extends JpaRepository<Booking, Long> {
   ...
   * @return a list of all bookings in the specified state. A collection with 0 elements is returned
   *     if there is no bookings making the provided state
   */
