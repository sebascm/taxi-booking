...
public class Location implements Serializable {
  ...
  @Transient private static final long serialVersionUID = -6935663821232865289L;

  @Transient private static final double MIN_LATITUDE = -90;
  @Transient private static final double MAX_LATITUDE = 90;
  @Transient private static final double MIN_LONGITUDE = -180;
  @Transient private static final double MAX_LONGITUDE = 180;
  ...
  /**
   * Convert to maindenhead head grid reference. Code reference:
   * https://github.com/Smerty/jham/blob/master/src/main/java/org/smerty/jham/Location.java
   *
   * @param latitudeIn latitude.
   * @param longitudeIn longitude.
   * @return a string representation of the maidenhead grid reference for the latitude and
   *     longitude.
   */
