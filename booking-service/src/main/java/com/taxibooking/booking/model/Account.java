...
public class Account implements Serializable {
  ...
  @Transient private static final Logger LOGGER = Logger.getLogger(Account.class.getName());

  @Transient private static final long serialVersionUID = 1998061924459270142L;
