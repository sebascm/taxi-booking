...
public class Booking implements Serializable {
  ...
  @Transient private static final long serialVersionUID = -1373406783231928690L;
   ...
   * Cancel booking.
   *
   * @throws IllegalStateException unable to perform state transition due to invalid state.
   */
  ...
  public final double estimateCost(double scalar) {
    return this.roundToTwoDecimalPlaces(
        scalar * this.route.getDistanceInMiles() * this.route.getTimeInMinutes());
  }
