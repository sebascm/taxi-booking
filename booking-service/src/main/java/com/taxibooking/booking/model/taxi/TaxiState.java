...
/**
 * Interface representing a state a taxi can be in and common operations. State design pattern. A
 * behavioral pattern that provide a flexible alternative to subclasses and complex difficult to
