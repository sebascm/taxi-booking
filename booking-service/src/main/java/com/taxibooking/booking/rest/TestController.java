...
public class TestController {
  ...
  @Autowired private GoogleDistanceMatrixService googleMapAPIService;
  ...
  public String setUp() throws InvalidGoogleApiResponseException {
    ...
    Account passenger =
        new Account(
            ...
            "Vinod",
            "Kandula",
            AuthenticationUtils.hashPassword("vinod"),
            "07645346541",
            "vinod.kandula@gmail.com");
    passenger.setRole(AccountRole.PASSENGER);

    Account passenger2 =
        new Account("john.mac", "John", "Mac", password, "07645346541", "john.mac@example.com");
    passenger2.setRole(AccountRole.PASSENGER);

    Account passenger3 =
        new Account("tim.smith", "Tim", "Smith", password, "07526888826", "tim_smith@example.com");
    passenger3.setRole(AccountRole.PASSENGER);

    Account passenger4 =
        new Account("yorkie", "Poly", "Morphism", password, "02555346548", "yorkie@example.com");
    passenger4.setRole(AccountRole.PASSENGER);
    passenger4.setInActive();

    Account driver =
        new Account(
            "john.smith", "John", "Smith", password, "02345346548", "john.smith@example.com");
    driver.setRole(AccountRole.DRIVER);

    Account driver2 =
        new Account("joe.bloggs", "Joe", "Bloggs", password, "02345346548", "jblogs99@example.com");
