...
/**
 * An interface for defining and enforcing operations needed for interfacing with Google distance
 * matrix and geocode services.
 *
 * @author vinodkandula
 */
public interface GoogleDistanceMatrixService {
   ...
   * @return distance between origin and destination.
   * @throws InvalidGoogleApiResponseException a
   */
