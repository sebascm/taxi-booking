...
public class GoogleDistanceMatrixServiceIT {
  ...
  /**
   * Test of getDistance method, of class GoogleDistanceMatrixService for same start and end
   * location.
   */
  @Test
  public void testGetDistanceForSameStartEnd() {
    ...
    try {
      actual =
          this.googleDistanceMatrixService.getDistance(
              "Innovation Centre, Hatfield Hertfordshire AL10 9PN, UK",
              "Innovation Centre, Hatfield Hertfordshire AL10 9PN, UK");
  ...
  public void testGetGeocodeLatLngFromAddress() {
    ...
    try {
      location =
          this.googleDistanceMatrixService.getGeocode(
              "University of Hertfordshire Main Building, College Ln, Hatfield, "
  ...
  /** Test of getDistance method, of class GoogleDistanceMatrixService for valid route. */
  @Test
  public void testGetDistanceForValidRoute() {
    ...
    try {
      actual =
          this.googleDistanceMatrixService.getDistance(
              "Innovation Centre, Hatfield, " + "Hertfordshire AL10 9PN, UK",
              "Sandridge, Hatfield, Hertfordshire AL10 9BL, UK");
    } catch (InvalidGoogleApiResponseException ex) {
      fail();
    }
